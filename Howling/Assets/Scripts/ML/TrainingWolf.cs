...
public class TrainingWolf : Agent

{
...

    {
        ...
        for (int i = 0; i < (int)ActionType.GOTOPLAYER; ++i)
...

    {
...

        {
             ...
             GameObject playerObj = FirstAdjacent("Player", Eyesight/2);

 

            Vector3 direction = (playerObj.transform.position - transform.position).normalized; // 타겟으로 향하는 방향
